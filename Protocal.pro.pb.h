...
#ifndef PROTOBUF_Protocal_2epro__INCLUDED
...
inline void InitDefaults() {
  InitDefaultsPBindName();
  InitDefaultsPChat();
  InitDefaultsPRoomInformation();
}
}  // namespace protobuf_Protocal_2epro
class PBindName;
...
class PBindName : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PBindName) */ {
 ...
 private:
  ...
  friend struct ::protobuf_Protocal_2epro::TableStruct;
  friend void ::protobuf_Protocal_2epro::InitDefaultsPBindNameImpl();
};
// -------------------------------------------------------------------
...
class PChat : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PChat) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_Protocal_2epro::TableStruct;
  friend void ::protobuf_Protocal_2epro::InitDefaultsPChatImpl();
};
// -------------------------------------------------------------------
...
class PRoomInformation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PRoomInformation) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_Protocal_2epro::TableStruct;
  friend void ::protobuf_Protocal_2epro::InitDefaultsPRoomInformationImpl();
};
// ===================================================================
...
#endif  // PROTOBUF_Protocal_2epro__INCLUDED
